...
.. warning:: Ruby applications belong in your :ref:`basics-home`, **not** in your :ref:`web-documentroot`.
...
``gem`` is a package manager that can be used to install and manage additional libraries, known as `gems`. We have preconfigured ``gem`` to install libraries to your :ref:`basics-home`.
